...
namespace XMail
{
    ...
    public class Imap4Controller
    {
        ...
        {
            if (this.Imap4Client != null && this.Imap4Client.IsConnected)
            {
                this.Imap4Client.Disconnect();
            }
        }
        ...
        {
            // We create a mailbox.
            this.Imap4Client.CreateMailbox(name);
        }
        ...
        {
            // Rename it.
            this.Imap4Client.RenameMailbox(oldName, newName);
        }
        ...
        public void DeleteMailbox(string name)
        {
            ...
            Mailbox mailbox = this.Imap4Client.SelectMailbox(name);
            mailbox.Empty(false);

            // We delete the mailbox from the account
            this.Imap4Client.DeleteMailbox(name);
        }
        ...
        {
            return this.Imap4Client.GetMailboxes(mailboxBase, "*");
        }
